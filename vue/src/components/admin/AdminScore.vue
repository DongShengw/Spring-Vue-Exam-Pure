          ...
          <el-button @click="checkGrade(scope.row.studentId)" type="primary">查看成绩</el-button>
            ...
            <el-table-column label="操作">
              <template #default="scope">
                ...
                <el-popconfirm title="确认删除?" @confirm="handleDelete(scope.row.scoreId)">
                  <template #reference>
      ...
      <el-dialog v-model="dialogVisible" title="提示" width="30%">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="考试名称">
            <el-input v-model="form.subject" style="width:80%"/>
          </el-form-item>
          <el-form-item label="分数">
            <el-input v-model="form.etScore" style="width:80%"/>
          </el-form-item>
          <el-form-item label="考试日期">
            <el-input v-model="form.answerDate" style="width:80%"/>
          </el-form-item>
        </el-form>
        <template #footer>
...
export default {
  ...
  methods: {
    ...
    checkGrade(studentId) {
      this.$router.push({ path: "/adminScoreOne", query: { studentId: studentId } });
    },
    handleDelete(id) {
      console.log(id)
